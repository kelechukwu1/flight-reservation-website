...
const BookFlightForm = () => {
  ...
  const handleInputDate = () => {
    const departureDateInput = departureDateRef.current.value;
    const returnDateInput = returnDateRef.current.value;

    const departureDate = new Date(departureDateInput).getTime();
