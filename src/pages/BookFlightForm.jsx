...
const BookFlightForm = () => {
  ...
  const handleDateInput = () => {
    const departureDatevar = new Date(flightDetails.departureDate).getTime();
          ...
          >
            <div className="w-full flex">
              <div className="mt-3 w-full p-2">
                ...
                <select
                  onChange={(e) => (flightDetails.flightType = e.target.value)}
                  name="flightType"
            ...
            <div className="flex px-2 gap-3">
              <div className="mt-3 w-full">
                ...
                <div className="w-full">
                  <select
                    onChange={(e) =>
                      (flightDetails.flyingFrom = e.target.value)
                    }
                    name="flyingFrom"
              ...
              <div className="w-full mt-3">
                ...
                <div>
                  <select
                    onChange={(e) => (flightDetails.flyingTo = e.target.value)}
                    name="flyingTo"
              ...
              <div className="mt-3 w-full">
                ...
                <div>
                  <input
                    ...
                    type="date"
                    name="departureDate"
                    placeholder={flightDetails.departureDate}
            ...
            <div className="md:flex justify-center md:justify-between md:p-2">
              <div className="mt-3 px-2">
                ...
                <select
                  onChange={(e) => (flightDetails.adult = e.target.value)}
                  name="adult"
              ...
              <div className="mt-3 px-2">
                ...
                <select
                  onChange={(e) => (flightDetails.child = e.target.value)}
                  name="child"
                  className="p-2 border-2 font-semibold w-full mr-2 md:w-[18rem] lg:w-[20rem] h-16 text-xl border-blue-900 focus:border-blue-500 focus:ring-blue-500 rounded"
                >
                  <option>0</option>
              ...
              <div className="mt-3 px-2">
                ...
                <select
                  onChange={(e) => (flightDetails.infant = e.target.value)}
                  name="infant"
                  className="p-2 border-2 font-semibold w-full mr-2 md:w-[18rem] lg:w-[20rem] h-16 text-xl border-blue-900 focus:border-blue-500 focus:ring-blue-500 rounded"
                >
                  <option>0</option>
