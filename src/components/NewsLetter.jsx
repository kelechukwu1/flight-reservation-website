...
const NewsLetter = () => {
	return (
		<div className=" bg-gray-100 w-full rounded text-center p-10">
			<div className="bg-gray-50 rounded p-10">
				<h1 className="text-3xl md:text-6xl font-bold md:pb-5 ">
					Like travel deals?
				</h1>
				<p className="text-grey md:text-3xl text-2xl pt-3 md:pt-0">
				...
				<div className="xl:px-2 px-[2.5rem] mt-4">
